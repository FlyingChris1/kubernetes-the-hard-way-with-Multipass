...
multipass launch --cloud-init controller-cloud-config.yml --disk 10G --memory 1G --cpus 1 --name controller-1
Start-Sleep -Seconds 20

multipass launch --cloud-init controller-cloud-config.yml --disk 10G --memory 1G --cpus 1 --name loadbalancer
Start-Sleep -Seconds 20

multipass launch --cloud-init worker-cloud-config.yml --disk 15G --memory 2G --cpus 1 --name worker-1
Start-Sleep -Seconds 20

multipass launch --cloud-init worker-cloud-config.yml --disk 15G --memory 2G --cpus 1 --name worker-2
